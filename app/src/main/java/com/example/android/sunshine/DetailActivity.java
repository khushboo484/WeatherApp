...
public class DetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public static final String[] Data_Columns ={WeatherContract.WeatherEntry.COLUMN_DATE,WeatherContract.WeatherEntry.COLUMN_MAX_TEMP, WeatherContract.WeatherEntry.COLUMN_MIN_TEMP,
            WeatherContract.WeatherEntry.COLUMN_HUMIDITY, WeatherContract.WeatherEntry.COLUMN_PRESSURE, WeatherContract.WeatherEntry.COLUMN_WIND_SPEED, WeatherContract.WeatherEntry.COLUMN_DEGREES,
    ...
    private static final int ID_DETAILS_LOADER = 353;
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle bundle) {
        switch (id) {
            case ID_DETAILS_LOADER:
                return new CursorLoader(this, mUri, Data_Columns, null, null, null);
            default:
